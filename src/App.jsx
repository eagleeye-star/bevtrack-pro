...
const INITIAL_PRODUCTS = [
  { id: 1, name: "Coke 500ml", brand: "Coca-Cola Ghana", unit: "Bottle", costPrice: 3.5, sellPrice: 5.0, stock: 144, reorderLevel: 24, expiry: "2026-12-31" },
  { id: 2, name: "Fanta Orange 500ml", brand: "Coca-Cola Ghana", unit: "Bottle", costPrice: 3.5, sellPrice: 5.0, stock: 72, reorderLevel: 24, expiry: "2026-11-30" },
  { id: 3, name: "Sprite 500ml", brand: "Coca-Cola Ghana", unit: "Bottle", costPrice: 3.5, sellPrice: 5.0, stock: 48, reorderLevel: 24, expiry: "2026-11-30" },
  { id: 4, name: "Kasapreko Royal Lager", brand: "Kasapreko", unit: "Bottle", costPrice: 6.0, sellPrice: 9.0, stock: 96, reorderLevel: 36, expiry: "2026-10-15" },
  { id: 5, name: "Voltic Still Water 1L", brand: "Voltic Ghana", unit: "Bottle", costPrice: 2.8, sellPrice: 4.5, stock: 10, reorderLevel: 30, expiry: "2027-06-30" },
  { id: 6, name: "Guinness Extra Stout", brand: "Guinness Ghana", unit: "Bottle", costPrice: 7.5, sellPrice: 11.0, stock: 60, reorderLevel: 24, expiry: "2026-09-30" },
  { id: 7, name: "Fan Ice Vanilla", brand: "Fan Milk", unit: "Piece", costPrice: 1.5, sellPrice: 2.5, stock: 200, reorderLevel: 50, expiry: "2026-07-15" },
];
const INITIAL_SALES = [
  { id: 1, date: "2026-06-25", items: [{ productId: 1, qty: 6, price: 5.0 }, { productId: 7, qty: 10, price: 2.5 }], total: 55.0, payment: "Cash", cashier: "Abena", customer: "Walk-in" },
  { id: 2, date: "2026-06-25", items: [{ productId: 4, qty: 4, price: 9.0 }, { productId: 6, qty: 2, price: 11.0 }], total: 58.0, payment: "MoMo", cashier: "Kofi", customer: "Bar Akosua" },
  { id: 3, date: "2026-06-26", items: [{ productId: 2, qty: 12, price: 5.0 }, { productId: 5, qty: 6, price: 4.5 }], total: 87.0, payment: "Cash", cashier: "Abena", customer: "Chop Bar Yaw" },
  { id: 4, date: "2026-06-26", items: [{ productId: 1, qty: 24, price: 4.5 }], total: 108.0, payment: "Credit", cashier: "Kofi", customer: "Mr. Mensah Wholesaler" },
  { id: 5, date: "2026-06-27", items: [{ productId: 6, qty: 6, price: 11.0 }, { productId: 4, qty: 6, price: 9.0 }], total: 120.0, payment: "Cash", cashier: "Abena", customer: "Walk-in" },
];
const INITIAL_DELIVERIES = [
  { id: 1, date: "2026-06-20", supplier: "Coca-Cola Ghana", driver: "Kwame Asante", truck: "GE 4821-22", items: [{ productId: 1, qtyOrdered: 200, qtyReceived: 196, cost: 3.5 }, { productId: 2, qtyOrdered: 100, qtyReceived: 100, cost: 3.5 }], status: "Completed" },
  { id: 2, date: "2026-06-22", supplier: "Kasapreko", driver: "Joe Boateng", truck: "AS 7700-21", items: [{ productId: 4, qtyOrdered: 120, qtyReceived: 120, cost: 6.0 }], status: "Completed" },
];
const INITIAL_CUSTOMERS = [
  { id: 1, name: "Bar Akosua", phone: "0244 123 456", type: "Bar", creditLimit: 500, creditBalance: 0 },
  { id: 2, name: "Mr. Mensah Wholesaler", phone: "0277 987 654", type: "Wholesaler", creditLimit: 2000, creditBalance: 108 },
  { id: 3, name: "Chop Bar Yaw", phone: "0555 321 000", type: "Chop Bar", creditLimit: 300, creditBalance: 0 },
];
